...
```powershell
python -m pulpit_ink.cli.main transcribe `
...
```powershell
python -m pulpit_ink.cli.main jobs list --limit 5
python -m pulpit_ink.cli.main jobs show <job-id>
python -m pulpit_ink.cli.main corrections list <job-id>
```
