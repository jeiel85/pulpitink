...
* :class:`~pulpitink.core.reference.parser.ParsedReference` — structured
...
* :class:`~pulpitink.core.reference.corrections.CorrectionEngine` —
  pending correction suggestions for the user to apply or ignore.
"""

from pulpitink.core.reference.aligner import (
    AlignmentPair,
...
from pulpitink.core.reference.parser import (
    SUPPORTED_REFERENCE_EXTENSIONS,
    ParsedReference,
    parse_reference,
    read_reference_file,
)
from pulpitink.core.reference.prompt_builder import (
    ReferencePrompt,
