...
Built on Typer. Keep the CLI thin — orchestrate ``pulpitink.services``
...
from pulpitink import __version__
...
from pulpitink.core.reference.corrections import apply_correction_to_segment
from pulpitink.core.transcription.base import (
    TranscriptionResult,
    TranscriptSegment,
)
from pulpitink.services.diagnostics import DoctorReport, run_doctor
from pulpitink.services.model_service import list_models, model_cache_dir
