...
from pulpitink.app.exceptions import (
    PulpitInkError,
    UnsupportedFormatError,
)
from pulpitink.core.audio.enhancement_presets import get_preset
from pulpitink.core.audio.ffmpeg_runner import DEFAULT_PRESET, FFmpegRunner
from pulpitink.core.export.base import ExportFormat
from pulpitink.core.export.pipeline import ExportPipeline
from pulpitink.core.postprocess import Lexicon, load_user_lexicon, postprocess_text
...
logger = logging.getLogger("pulpitink.services.transcribe")
...
def _build_engine(model: str, device: str, compute_type: str) -> TranscriptionEngine:
    ...
    from pulpitink.core.transcription.faster_whisper_engine import FasterWhisperEngine
