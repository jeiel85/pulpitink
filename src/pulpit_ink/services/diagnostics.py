"""``PulpitInk doctor`` business logic.
...
from pulpit_ink.core.audio.ffmpeg_runner import FFmpegRunner
...
def _check_app_data_dir() -> DoctorResult:
    ...
    try:
        paths.ensure()
        probe = paths.data_dir / ".PulpitInk_write_test"
