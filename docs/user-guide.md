...
```powershell
PulpitInk transcribe sermon.mp3
```
...
```powershell
PulpitInk transcribe sermon.mp3 --reference sermon.md --language ko
```
...
```powershell
PulpitInk transcribe sermon.mp3 --user-dict .\my-dict.json
```
...
```powershell
PulpitInk jobs list --limit 20
PulpitInk jobs show <job-id>
PulpitInk jobs export <job-id> --format md,srt --output .\re-exports
```
...
```powershell
PulpitInk settings show
PulpitInk settings set language ko
PulpitInk settings set model small
PulpitInk settings set preset sermon
PulpitInk settings set output_dir D:\sermons\exports
PulpitInk settings set model_cache_dir D:\sermons\models
PulpitInk settings set fuzzy_matching_enabled true
PulpitInk settings set fuzzy_threshold 0.75
```
...
```powershell
PulpitInk --verbose transcribe sermon.mp3
```
